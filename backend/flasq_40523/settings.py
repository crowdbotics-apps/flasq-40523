"""
Django settings for flasq_40523 project.
...
WSGI_APPLICATION = 'flasq_40523.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "flasq_40523 API",
    "DESCRIPTION": "API documentation for flasq_40523 App",
    "VERSION": "v1",
}
